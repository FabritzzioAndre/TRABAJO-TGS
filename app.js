const BASE_POSTS = [
  {
    ...
    "title": "Percepción sobre la limitada variedad de alimentos disponibles para los estudiantes de la FISI",
    "summary": "Análisis sistémico enfocado en la problemática de la poca variedad y repetición de menús en los cafetines de la facultad, evaluando la insatisfacción estudiantil y proponiendo alternativas de solución.",
    "tags": ["sistemas", "alimentación", "UNSM", "FISI"]
  },
  {
    "type": "Mapa mental",
    "date": "04 SEP 2026",
    "course": "Cálculo Diferencial e Integral",
    "title": "Conceptos clave para el estudio de funciones",
    "summary": "Síntesis visual de dominio, rango, comportamiento de funciones y relaciones importantes para el desarrollo del curso.",
    "tags": ["cálculo", "funciones", "resumen"]
  },
  {
    "type": "Presentación",
    "date": "29 AGO 2026",
    "course": "Base de Datos",
    "title": "Modelo relacional y organización de la información",
    "summary": "Presentación sobre entidades, atributos, relaciones y buenas prácticas para estructurar información de manera consistente.",
    "tags": ["datos", "modelo relacional", "SQL"]
  },
  {
    "type": "Investigación",
    "date": "22 AGO 2026",
    "course": "Metodología de la Investigación",
    "title": "Planteamiento de un problema académico",
    "summary": "Ejemplo aplicado de delimitación del problema, formulación de objetivos y organización de antecedentes para un trabajo universitario.",
    "tags": ["investigación", "objetivos", "metodología"]
  },
  {
    "type": "Práctica",
    "date": "15 AGO 2026",
    "course": "Programación",
    "title": "Resolución estructurada de problemas con algoritmos",
    "summary": "Práctica enfocada en descomponer problemas, diseñar pseudocódigo y comprobar resultados antes de implementar una solución.",
  ...
  },
  {
    ...
    "title": "Aprender, documentar y mejorar",
    "summary": "Reflexión breve sobre la importancia de registrar el proceso de aprendizaje y utilizar la retroalimentación para mejorar.",
    "tags": ["aprendizaje", "reflexión", "portafolio"]
  }
];

const STORAGE_KEY = "blog_fabritzzio-jara_posts";
const COMMENT_PREFIX = "blog_fabritzzio-jara_comments_";
